...
@section('content')
  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-3 gap-2">
    <a href="{{ route('disposisi.penerima') }}"
      class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-md text-xs px-3 py-2 tracking-wide focus:outline-none capitalize w-fit">
      <i class="fa-solid fa-circle-check mr-2"></i> Disposisi yang anda terima
    </a>

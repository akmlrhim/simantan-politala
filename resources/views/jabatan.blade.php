        ...
        <form class="p-4 md:p-5" method="POST" action="{{ route('jabatan.store') }}">
          ...
          <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
              <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jabatan </label>
              <input type="text" name="nama" id="nama"
                ...
                placeholder="Masukkan nama jabatan" autocomplete="off" value="{{ old('nama') }}" />
              @error('nama')
          ...
          <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
              ...
              <input type="text" name="nama" id="edit_nama"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm font-medium rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Masukkan jabatan" autocomplete="off" value="{{ old('nama') }}" />
              @error('nama')

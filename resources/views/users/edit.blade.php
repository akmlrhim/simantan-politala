        ...
        <div class="container mx-auto p-4">
          <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="grid gap-4">
              <div class="sw-full">
                <label for="nama"
                  class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama
                  Lengkap</label>
              ...
              <div>
                ...
                @error('role')
                  <small
                    class="text-red-500 font-medium text-xs mt-1 capitalize">{{ $message }}</small>
                @enderror
              </div>
              ...
              <div>
                ...
                <select id="jabatan" name="jabatan_id"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm font-medium rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full md:w-3/4 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
            ...
            <div class="mt-4">
              ...
              <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ubah
                Data</button>
            </div>
          </form>
        </div>

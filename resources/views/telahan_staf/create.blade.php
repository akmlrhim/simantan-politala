            ...
            <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 md:w-3/4">
              ...
              <div class="w-full md:w-3/4">
                <select class="select2 w-full" name="dari" id="dari">
                  <option disabled {{ old('dari') == '' ? 'selected' : '' }} value="">Pilih dari</option>
                  @foreach ($jabatan as $id => $item)
                    <option value="{{ $id }}" {{ old('dari') == $id ? 'selected' : '' }}>
                      {{ $item }}
                    </option>
                  @endforeach
                </select>
            ...
            <div
              ...
              <div class="w-full md:w-3/4">
                <select class="select2 w-full" name="perihal" id="perihal">
                  <option disabled {{ old('perihal') == '' ? 'selected' : '' }} value="">Pilih perihal</option>
                  @foreach ($jenisSurat as $id => $item)
                    <option value="{{ $id }}" {{ old('perihal') == $id ? 'selected' : '' }}>
                      {{ $item }}
                    </option>
                  @endforeach
                </select>

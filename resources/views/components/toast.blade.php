@if (session('success'))
  <div id="toast-success"
    ...
    <div class="ms-3 text-xs font-medium">{{ session('success') }}</div>
...
@if (session('error'))
  <div id="toast-danger"
    ...
    <div class="ms-3 text-xs font-medium">{{ session('error') }}</div>
...
@if (session('info'))
  <div id="toast-info"
    ...
    <div class="ms-3 text-xs font-medium">{{ session('info') }}</div>

@if (session('success'))
  <div id="toast-success"
    class="fixed top-4 right-4 z-50 flex items-center max-w-xs w-full p-4 mb-4 md:text-sm text-sm text-gray-700 bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:text-gray-300"
    role="alert">
    <div

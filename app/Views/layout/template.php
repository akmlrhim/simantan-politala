									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-4 stock-detail">
												<p>
													<i class="mdi mdi-cellphone text-primary mr-2 mt-3 font-24"></i>20% Mobiles
												</p>
												<p>
													<i class="mdi mdi-tablet-android text-success mr-2 mt-3 font-24"></i>20% Tablets
												</p>
												<p>
													<i class="mdi mdi-laptop text-danger mr-2 mt-3 font-24"></i>20% Laptops
												</p>
												<p>
													<i class="mdi mdi-television text-info mr-2 mt-3 font-24"></i>40% Televisions
												</p>
											</div>
										</div>
									</div>
								...
								<div class="card m-b-30 h-360">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-6 align-self-center text-center">
												<h6 class="font-40">
													<i class="mdi mdi-menu-up text-success"></i>52 %
												</h6>
											</div>
										</div>
										...
										<div class="table-responsive">
											<table class="table table-hover mb-0">
												...
												<tbody>
													<tr>
														<td>
															<img class="" src="assets/images/products/pro1.png" alt="user" width="40">
														</td>
														<td>
															Chair
														</td>
													...
													<tr>
														<td>
															<img class="" src="assets/images/products/pro2.png" alt="user" width="40">
														</td>
														<td>
															Mobile
														</td>
													...
													<tr>
														<td>
															<img class="" src="assets/images/products/pro3.png" alt="user" width="40">
														</td>
														<td>
															LED
														</td>
													...
													<tr>
														<td>
															<img class="" src="assets/images/products/pro4.png" alt="user" width="40">
														</td>
														<td>
															Chair
														</td>
										...
										<div class="table-responsive">
											<table class="table table-hover mb-0">
												...
												<tbody>
													<tr>
														<td>
															<img class="rounded-circle" src="assets/images/users/avatar-2.jpg" alt="user" width="40">
														</td>
														<td>
													...
													<tr>
														<td>
															<img class="rounded-circle" src="assets/images/users/avatar-3.jpg" alt="user" width="40">
														</td>
														<td>
													...
													<tr>
														<td>
															<img class="rounded-circle" src="assets/images/users/avatar-4.jpg" alt="user" width="40">
														</td>
														<td>
													...
													<tr>
														<td>
															<img class="rounded-circle" src="assets/images/users/avatar-5.jpg" alt="user" width="40">
														</td>
														<td>

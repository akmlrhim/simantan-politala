			...
			<div class="card-body">
				<form action="<?= base_url('surat-masuk/tambah'); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="date" class="form-control" id="tanggal_diterima" name="tanggal_diterima" placeholder="Tanggal Diterima" autocomplete="off" value="<?= old('tanggal_diterima'); ?>" onfocus="this.showPicker()">
							<small class="form-text text-muted">Tanggal Diterima</small>
						</div>
						<div class="col-sm-5">
							<input type="date" class="form-control" id="tanggal_surat" name="tanggal_surat" placeholder="Tanggal Surat" autocomplete="off" value="<?= old('tanggal_surat'); ?>" onfocus="this.showPicker()">
